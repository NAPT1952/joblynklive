        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "50px" }}>
            ...
            <h2 style={{
              ...
              maxWidth: "700px",
              margin: "0 auto"
            }}>Bridging the Gap Between Jobs & Talent</h2>
          </div>
          ...
          <div style={{
            ...
            <div>
              <p style={{
                ...
                JobLynk.live was born from a simple observation: millions of skilled Indian workers— from factory floors to home offices—struggle to present themselves professionally to employers. Either resumes are too expensive, or job platforms are too complicated.
              </p>
              <p style={{ fontSize: "1.1rem", color: "#334155", lineHeight: "1.7" }}>
                We started in 2024 with a clear mission: <strong>make job application tools affordable (₹49/₹99) and brutally simple.</strong> No confusing dashboards. No hidden fees. Just your resume, cover letter, and a direct line to employers who are actually hiring.
              </p>
            ...
            <div style={{ background: "#e6f0ff", borderRadius: "32px", padding: "40px" }}>
              ...
              <ul style={{ listStyle: "none", padding: 0 }}>
                <li style={{ marginBottom: "25px", display: "flex", gap: "15px", alignItems: "flex-start" }}>
                  <span style={{
                    background: "#2563eb",
                    color: "white",
                    width: "28px",
                  ...
                  <span style={{ fontSize: "1.1rem" }}><strong>No monthly fees</strong> – Pay once, get your documents forever</span>
                </li>
                <li style={{ marginBottom: "25px", display: "flex", gap: "15px", alignItems: "flex-start" }}>
                  <span style={{
                    background: "#2563eb",
                  ...
                  <span style={{ fontSize: "1.1rem" }}><strong>Real human support</strong> – Email us, get reply within hours</span>
                </li>
                <li style={{ display: "flex", gap: "15px", alignItems: "flex-start" }}>
                  ...
                  <span style={{ fontSize: "1.1rem" }}><strong>Privacy first</strong> – Your Aadhaar and data are encrypted</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ color: "#64748b" }}>Web Master & Owner</p>
            </div>
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <h3 style={{ margin: "0 0 5px 0" }}>Das Suburaj</h3>
              <p style={{ color: "#64748b" }}>Data Engineer & Support</p>
            </div>
          </div>
        </div>
      </div>
